...
-o captain-nicebeard/game/js/class.js -m -screw-ie8 
...
-o captain-nicebeard/game/js/nicebeard.js -m -c -screw-ie8 

uglifyjs \
tanks-in-time/game/my-game.js \
-o captain-nicebeard/game/my-game.js -m -c -screw-ie8 

uglifyjs \
tanks-in-time/game/js/perlin.js \
-o captain-nicebeard/game/js/perlin.js -m -c -screw-ie8 